...
* The original package name 'com.example.booking-system' is invalid and this project uses 'com.example.booking_system' instead.
...
* [Validation](https://docs.spring.io/spring-boot/4.2.0-SNAPSHOT/reference/io/validation.html)
